classdef MILP_unsig_int_1_MergingZoneCruiser < matlab.DiscreteEventSystem & ...
    ...
    methods (Access=protected)        
        ...
        function [entity, events] = CAVEntryImpl(obj, storage, entity, ~)
            ...
            if storage == 1 % CAV enters the MZ
            ...
            switch tag                
                case 'MZ'
                    if entity.data.ID ~= 1001
                        ...
                        % exiting the merging zone
                        if abs(entity.data.Position) >= 2*obj.d_access + obj.S
